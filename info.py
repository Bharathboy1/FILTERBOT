...
LOG_STR += ("IMDB Results are enabled, Bot will be showing imdb details for you queries.\n" if IMDB else "IMBD Results are disa
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🔖 ᴛɪᴛʟᴇ : <b>{title}</b>\n \n 📆 ʀᴇʟᴇᴀsᴇ : {year} \n 🌟 ʀᴀᴛɪɴɢ : {rating} \n 🎭 ɢᴇɴʀᴇ : {genres} \n 📆 ʀᴇʟᴇᴀsᴇ : {year} \n🎙️ʟᴀɴɢᴜᴀɢᴇ : {languages} \n🔖 sʜᴏʀᴛ : {plot} \n★ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : @GreyMatter_Bots")
...
URL_SHORTNER_WEBSITE_API = environ.get, '48c577757243620c64c7b6536fce211fc264e7ad')
